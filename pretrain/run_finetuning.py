...
def main():
  ...
  parser.add_argument("--data-dir", default='/home/osh7605/KoELECTRAModels/KoCharELECTRA_small_wiki_basic_prepro/models/ll',
                      help="Location of data files (model weights, etc).")
  parser.add_argument("--model-name", default='finetune',
